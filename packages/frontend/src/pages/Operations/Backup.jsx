...
const WorkflowContainer = ({ 
  ...
  return (
    <div className={`flex h-screen bg-background text-foreground ${className}`}>
      {/* Sidebar */}
      <div className={`${isCollapsed ? 'w-16' : 'w-72'} border-r border-border bg-card transition-all duration-300`}>
        {sidebarHeader}
 ...
 */
const NavigationItem = ({ icon: Icon, label, description, isActive, onClick }) => (
  <button
    onClick={onClick}
